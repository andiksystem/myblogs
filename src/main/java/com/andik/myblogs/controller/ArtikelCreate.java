...
@Named
@ViewScoped
public class ArtikelCreate implements Serializable {
    ...
    public void save() {
        try {
            ...
            Logger.getLogger(ArtikelCreate.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(ArtikelCreate.class.getName());
